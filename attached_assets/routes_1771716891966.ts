...
export async function registerRoutes(app: Express): Promise<Server> {
  // Contact form submission — saves directly to PostgreSQL via Drizzle
  ...
  // ElevenLabs redirect endpoint (called from your Express server,
  // NOT the Supabase edge function — that's a separate thing)
  app.post("/api/elevenlabs-redirect", async (req, res) => {
    try {
      // Accept any shape ElevenLabs sends
      console.log(
